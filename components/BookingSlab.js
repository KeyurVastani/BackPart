...
const BookingSlab = ({ item, onPress, cancleDisable =false}) => {
    ...
    return (
        ...
        <View style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                {cancleDisable &&   <View style={styles.container2}>
                <TouchableOpacity style={styles.touch} onPress={onPress}>
                    <Text style={{ color: 'red',fontSize:16}}>Cancle Booking</Text>
                    </TouchableOpacity>
                </View> }
...
const styles=StyleSheet.create({
    ...
    image:{
           ...
           fontSize:20,fontFamily:'roboto',paddingLeft:15,marginBottom:3
    },container1:{
